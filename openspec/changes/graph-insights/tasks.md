...
### Phase K · 归档（2026-04-25 完成）

- [x] 复制 `openspec/changes/graph-insights/{proposal,design,tasks}.md + specs/*` 到 `docs/superpowers/archive/graph-insights/`（bash cp · 保持一致）
- [x] 新增 `docs/superpowers/archive/graph-insights/ARCHIVED.md`（含 verification checklist 待用户本机填）
- [x] `openspec/changes/graph-insights/` 保留作为活契约（未来扩展引用本目录）
- [x] 新增 ADR：`.superpowers-memory/decisions/2026-04-25-41-graph-insights.md`（D-001~D-009 决策 + 代码清单 + Links）
- [x] `.superpowers-memory/MEMORY.md` 索引更新（日期维度新增 2026-04-25 snapshot 链接 · 主题维度新增"Graph Insights"区块 · 未解问题区追加 OQ-GI-FUTURE-1/2/3）
- [x] `.superpowers-memory/open-questions.md` 新增 3 条 OQ-GI-FUTURE-*：
  - [x] `OQ-GI-FUTURE-1` — 跨 Space 全局视图（Admin）触发条件
  - [x] `OQ-GI-FUTURE-2` — Notebook 级洞察下钻
  - [x] `OQ-GI-FUTURE-3` — Dismissed 列表管理 UI
- [x] `.superpowers-memory/open-questions.md` 已关闭表追加"llm_wiki 图谱洞察接入"行
- [x] 新增 PROGRESS-SNAPSHOT-2026-04-25-graph-insights.md（六章：起因 / 工作流四步 / 关键决策回顾 / 衍生 OQ / 复盘要点 / 不动清单）
